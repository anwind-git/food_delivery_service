# Интернет-магазин для деятельности ресторанов, услуги по доставке продуктов питания. Django, Nginx, Celery + Redis, Gunicorn, Docker-Compose, TeleBot, Certbot

#### Данный проект был разработан с целью автоматизации процесса заказа продуктов питания до потребителя. В процессе разработки, были использованы следующие инструменты:

...
Пример магазина: https://vkusnyeedy.ru/
...
#### Для дальнейшей работы уже должно быть приобретено доменное имя, зарегистрирован аккаунт в [Юкасса](https://yookassa.ru/) - для начала можно использовать тестовый магазин, [Dadata](https://dadata.ru/) - подсказки при вводе адреса и email клиентом, получен токен [Telegram бота](https://t.me/BotFather). Облачный сервер например [VDS by selectel](https://vds.selectel.ru/) - где все и будет происходить далее.
...
Удаляем там все и вставляем новые настройки, незабываем снова вписать домен, в этом случае уже два раза:
...
![Пример изображения](images/structure.jpg)
